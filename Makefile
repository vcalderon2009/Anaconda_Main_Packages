...
PROFILE = default
PROJECT_NAME = Anaconda_Main_Packages
PYTHON_INTERPRETER = python3
CONDA_ENVIRONMENT_FILE = ./packages/conda_requirements.txt
PIP_ENVIRONMENT_FILE = ./packages/pip_requirements.txt
...
pip_requirements:
	pip install -r $(PIP_ENVIRONMENT_FILE)
